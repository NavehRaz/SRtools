...
def baysianDistance(sr1, sr2, time_range=None, dt =1, debug = False):
    """
    DEPRECATED: Use baysian_dirichlet_distance instead.
    ...
    import warnings
    warnings.warn(
        "baysianDistance is deprecated. Use baysian_dirichlet_distance instead.",
        DeprecationWarning,
        stacklevel=2
    )
    return baysian_dirichlet_distance(sr1, sr2, time_range=time_range, dt=dt, debug=debug)
